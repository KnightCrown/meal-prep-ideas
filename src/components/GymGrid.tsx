...
function PriorityExercisesModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-2xl p-8"
      ...
      >
        ...
        <h2
          ...
          className="text-xl font-bold text-zinc-900 dark:text-zinc-50 mb-5 pr-8"
        >
          Priority Exercises
        </h2>
